import {
  Card, Grid, Skeleton, TextField, Typography,
} from '@mui/material';
            ...
            >
              {item.inputType === 7 ? (
                <InputRadioGroup
                  ...
                  options={item.inputOptions.split(';')}
                  ...
                  <Grid item xs={7}>
                      ...
                      <Selector
                        ...
                        optionsBoxFinding={{
                          ...
                          inputOptions: item.inputOptions
                            .split(';')
                            .filter(
                              (itemFilter, indexFilter, self) => self.indexOf(itemFilter) === indexFilter,
                            ),
                        }}
                        label={item.inputLabel}
                    ...
                    {item.inputType === 4 && (
                      <TextField
                        ...
                        type="number"
                        variant="standard"
                        onChange={(e) => handleChangeInputNumber(item.id, item.inputLabel, e.target.value, tabName)}
                        placeholder="Input Number"
                        defaultValue={
                          patientFindingValueInput.valueNumricInput[tabName]
                            ? patientFindingValueInput.valueNumricInput[tabName][item.inputLabel]
                              ?.value
                            : undefined || undefined
                        }
                        fullWidth
                    ...
                    {item.inputType === 5 && (
                      <TextField
                        ...
                        id="outlined-basic"
                        variant="standard"
                        onChange={(e) => handleChangeInputText(item.id, item.inputLabel, e.target.value, tabName)}
                        defaultValue={
                          patientFindingValueInput.valueTextInput[tabName]
                            ? patientFindingValueInput.valueTextInput[tabName][item.inputLabel]
                              ?.value
                            : undefined || undefined
                        }
                        fullWidth
                    ...
                    {item.inputType === 6 && (
                      <TextField
                        key={item.id}
                        type="date"
                        onChange={(e) => handleChangeInputDate(item.id, item.inputLabel, e.target.value, tabName)}
                        defaultValue={
                          patientFindingValueInput.valueDateInput[tabName]
                            ? patientFindingValueInput.valueDateInput[tabName][item.inputLabel]
                              ?.value
                            : undefined || undefined
                        }
                        fullWidth
