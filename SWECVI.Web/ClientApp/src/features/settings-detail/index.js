...
export default function ParameterSettingsDetail() {
  ...
  const {
    handleCancel, settings, handleSubmitForm, openBackdrop,
  } = useSettingsDetail();
    ...
    <BaseLayout>
      <Formik
        ...
        initialValues={{
          ...
          functionSelectorName: settings?.functionSelectorName,
          departmentName: settings?.departmentName,
          fillter: settings?.fillter,
        }}
        onSubmit={(values) => {
          // console.log({
          //   ...values,
            ...
            >
              ...
              />
                    ...
                    <Grid item xs={12} sm={6}>
                      <Selector
                        // disableClearable
                key={values?.functionSelectorName}
                defaultValue={values?.functionSelectorName}
                label="Function Selector"
                options={functionSelector.map((item) => item.name)}
                onChange={(value) => setFieldValue('functionSelectorName', value)}
                value={values?.functionSelectorName}
              />
                    </Grid>
                    <Grid item xs={12} sm={6}>
                      <Selector
              ...
              />
                    ...
                    <Grid item xs={12} sm={6}>
                      <FormField
                value={values.fillter}
                type="number"
                name="fillter"
                label="Fillter"
                placeholder="Fill ter"
                onChange={handleChange}
                error={errors.fillter}
              />
                    </Grid>
                    <Grid item xs={12} sm={6}>
                      <FormControlLabel
              ...
              />
                ...
                control={(
                  <Switch
                            ...
                            onChange={(e) => setFieldValue('showInParameterTable', e.target.checked)}
                            color="primary"
              ...
              />
                ...
                control={(
                  <Switch
                            ...
                            onChange={(e) => setFieldValue('showInAssessmentText', e.target.checked)}
                            color="primary"
