...
export default function References() {
  ...
  const columns = [
    ...
    columnHelper.accessor('primaryReference', {
      id: 'primaryReference',
      header: 'Primary Reference',
    }),
    columnHelper.accessor('fistAuthor', {
      id: 'fistAuthor',
      header: 'Fist Author',
    }),
    ...
    columnHelper.accessor('', {
      ...
      cell: ({ row }) => (
        <Box style={{ textAlign: 'right' }}>
          <Button
            onClick={() => handleEditReferences(row.original.id)}
